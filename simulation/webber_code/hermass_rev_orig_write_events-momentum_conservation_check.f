...
c      READ *, NRS
      ...
      OPEN(UNIT=666,FILE='HERWIG-events_momentumcheck.dat')
      MAXEV=1000
      IPROC=13010
...
C--FOUND LEFT SQUARK (NOT ST OR SB) N.B. RIGHT SQUARKS HAVE SMALL B.R.
               ...
               IC=4*ISQ-3
               IP1=JDAHEP(1,IHEP)
               CALL HWVEQU(5,PHEP(1,IHEP),PSQ(1,ISQ))
...
C--JEM: WRITE EVENTS TO FILE
      WRITE(666,667)
 667  FORMAT('EVENT')
      WRITE(666,'(I5,4F12.4)') 666,PSQ(1,1),
     &PSQ(2,1),PSQ(3,1),PSQ(4,1)
      WRITE(666,'(I5,4F12.4)') IDCHP(1),PCH(1,1),
     &PCH(2,1),PCH(3,1),PCH(4,1)
      WRITE(666,'(I5,4F12.4)') IDCHP(2),PCH(1,2),
     &PCH(2,2),PCH(3,2),PCH(4,2)
      WRITE(666,'(I5,4F12.4)') IDCHP(3),PCH(1,3),
     &PCH(2,3),PCH(3,3),PCH(4,3)
      WRITE(666,'(I5,4F12.4)') IDCHP(4),PCH(1,4),
     &PCH(2,4),PCH(3,4),PCH(4,4)
      WRITE(666,'(I5,4F12.4)') 666,PSQ(1,2),
     &PSQ(2,2),PSQ(3,2),PSQ(4,2)
      WRITE(666,'(I5,4F12.4)') IDCHP(5),PCH(1,5),
     &PCH(2,5),PCH(3,5),PCH(4,5)
      WRITE(666,'(I5,4F12.4)') IDCHP(6),PCH(1,6),
     &PCH(2,6),PCH(3,6),PCH(4,6)
      WRITE(666,'(I5,4F12.4)') IDCHP(7),PCH(1,7),
     &PCH(2,7),PCH(3,7),PCH(4,7)
      WRITE(666,'(I5,4F12.4)') IDCHP(8),PCH(1,8),
